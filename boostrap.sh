...
# Install Kibana
curl -o /tmp/kibana.tar.gz https://download.elasticsearch.org/kibana/kibana/kibana-${KIBANA_VERSION}.tar.gz
sudo mkdir -p /var/www/kibana3
sudo tar xvzf /tmp/kibana.tar.gz -C /var/www/kibana --strip 1
sudo sed -i 's/\(^\s*elasticsearch.*\)9200/\180/g' /var/www/kibana3/config.js
curl -o /tmp/kibana.conf https://github.com/elasticsearch/kibana/raw/master/sample/nginx.conf
